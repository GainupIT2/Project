...
namespace Accounts
{
    public partial class FrmProjectIndentPOEntry : Form, Entry
    {
        ...
        int cc = 0;
        public FrmProjectIndentPOEntry()
        {
            InitializeComponent();
        }
        ...
        private void FrmProjectIndentPOEntry_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FrmProjectIndentPOEntry_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    if (this.ActiveControl.Name == "TxtBuyer")
                    {
                        Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Buyer", " Select LedgeR_Name Buyer, LedgeR_Code Code From Projects.Dbo.Buyer_All_Fn() ", String.Empty, 250);
                            if (Dr != null)
                            {
        ...
        private void FrmProjectIndentPOEntry_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (this.ActiveControl is TextBox)
