                ...
                else if (e.KeyCode == Keys.Down)
                {
                    if (MyParent._New == true || MyParent.Edit == true)
                    {
                        ...
                        if (this.ActiveControl.Name == "TxtSupplier")
                        {
                            ...
                            Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Supplier", " select Ledger_Name Supplier, Ledger_Code Supplierid from Supplier_all_Fn() Where LedgeR_Code in (Select Code From Testing_suppliers_Code()) Order By 1 ", String.Empty, 400);
