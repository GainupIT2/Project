...
namespace Accounts
{
    ...
    {
        public int UserCode, SysCode, CompCode;
        public String New_UserCode, New_SysCode, New_Today;
        ...
        public void Company_Initialization()
        {
            ...
            try
            {
                ...
                Str = "\\\\192.168.1.201\\vaahini\\PRojects";
        ...
        void MDICaption()
        {
            ...
            try
            {
                Sql = "PROJECTS : " + MyBase.PadR(CompName.ToUpper().Trim() + " ( " + YearCode.Trim() + " )", 77);
        ...
        private void pOIndentApprovalToolStripMenuItem_Click(object sender, EventArgs e)
        {
