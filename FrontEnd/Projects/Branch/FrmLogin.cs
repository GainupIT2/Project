...
namespace Accounts
{
    public partial class FrmLogin : Form
    {
        ...
        void Login()
        {
            try
            {
                //Projects_User_Master --Project User Table
                //#region Password Log
                ...
                else
                {
                    ...
                    MyBase.Load_Data("Select User_Code, Pass, Asci, Emplno From Projects.dbo.Projects_Login() where User_name = '" + CmbUser.Text + "'", ref Tdt);
                    if (Tdt.Rows.Count > 0)
                    {
        ...
        private void FrmLogin_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (System.IO.File.Exists("C:\\Vaahrep\\Projects.txt"))
                {
                    CreateLogCmp();
