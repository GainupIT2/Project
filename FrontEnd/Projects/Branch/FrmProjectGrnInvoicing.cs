    ...
    public partial class FrmProjectGrnInvoicing : Form, Entry
    {
        ...
        public void Entry_Edit()
        {
            try
            {
                MyBase.Clear(this);
                MyBase.Enable_Controls(this, true);
                Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Entry - Edit", "Select S1.Entry_No, S1.Entry_Date, L1.Ledger_Name SUpplier, S1.Invoice_No, S1.Invoice_Date, S1.Supplier_Code, S1.RowID Code, S1.Remarks, S1.Tax_Calc_Mode, S1.RO_Amt From Project_GRN_Invoicing_Master S1  Left join Supplier_All_Fn() L1 on S1.Supplier_Code = L1.Ledger_Code  Left Join ACCOUNTS.dbo.Socks_Grn_Debit_Approval A1 On A1.Rowid  = S1.Rowid and A1.Inv_Raised = 'PROJECT'   Left Join ACCOUNTS.dbo.ERp_Accounts_Project_Combo A2 On A2.InvNo = S1.Invoice_No and A2.Invdate = S1.Invoice_Date Where A1.RowID Is Null and A2.VCode IS Null", String.Empty, 120, 100, 250, 120, 100);
                if (Dr != null)
                {
                    Fill_Data(Dr);
                }
        ...
        public void Entry_View()
        {
            try
            {
                MyBase.Clear(this);
                MyBase.Enable_Controls(this, false);
                Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Entry - View", "Select S1.Entry_No, S1.Entry_Date, L1.Ledger_Name SUpplier, S1.Invoice_No, S1.Invoice_Date, S1.Supplier_Code, S1.RowID Code, S1.Remarks, S1.Tax_Calc_Mode, S1.RO_Amt From Project_GRN_Invoicing_Master S1  Left join Supplier_All_Fn() L1 on S1.Supplier_Code = L1.Ledger_Code  Left Join ACCOUNTS.dbo.GST_Grn_Approval A1 On A1.Invoice_No = S1.Invoice_No and A1.Invoice_Date = S1.Invoice_Date and A1.Supplier_Id = S1.Supplier_Code  Left Join ACCOUNTS.dbo.ERp_Accounts_Socks_Combo A2 On A2.InvNo = S1.Invoice_No and A2.Invdate = S1.Invoice_Date ", String.Empty, 120, 100, 250, 120, 100);
                if (Dr != null)
                {
                    Fill_Data(Dr);
                }
        ...
        public void Entry_Print()
        {
            try
            {
                ...
                Str = " Select S1.Entry_No PONo, L1.Ledger_Name Supplier, S1.Invoice_No Bill_No, Cast(S1.Entry_Date As date)PoDate, Cast(S1.Invoice_Date as Date) Required_Date, S2.Item_Type PO_Method,'' Supplier_Address, L1.Ledger_Phone Supplier_Phone, L1.Ledger_email Supplier_Email, S1.RO_Amt From Project_GRN_Invoicing_Master S1 Left Join Dbo.Supplier_All_Fn() L1 on S1.Supplier_Code = L1.Ledger_Code Left Join (Select Distinct A.Master_Id, '' Item_Type from Project_GRN_Invoicing_Details A Left Join Item B on A.Item_ID = B.itemid) S2 on S1.RowID = S2.Master_ID Where S1.RowID = " + Code;
