...
namespace Accounts
{
    public partial class FrmCRViewer : Form
    {
        ...
        public void LoadCR_Print(ref CrystalDecisions.CrystalReports.Engine.ReportDocument ObjRpt)
        {
            try
            {
                //CnInfo.ConnectionInfo.ServerName = "PSR_Ibmserver1";
                //CnInfo.ConnectionInfo.ServerName = "PSR";
                //MyBase.LoadOraDBName();
                //CnInfo.ConnectionInfo.ServerName = MyBase.OraDBName;
                ////CnInfo.ConnectionInfo.DatabaseName = "VaahiniPSRDB";
                //CnInfo.ConnectionInfo.UserID = MyBase.GetServerUserName();
                //CnInfo.ConnectionInfo.Password = MyBase.GetServerPass();

                //ObjRpt.Load(FilePath);
