...
namespace SelectionTool_NmSp
{
    class SelectionTool_Class
    {
        ...
        public DataTable Selection_Tool_Multiple(Form OwnerForm, int _Left, int _Top, ViewType V, String Title, String Sql, String RelatedWord, params int[] Column_Width)
        {
            FrmSelectionTool Main;
            ...
            if (V == 0)
            {
                Main.Grid_Detail_Multiple(false, Sql, Column_Width);
            }
            else
            {
                Main.Grid_Detail_Multiple(true, Sql, Column_Width);
            }
            Main.Caption(Title);
            Main.StartPosition = FormStartPosition.Manual;
            Main.Left = _Left;
            ...
            if (Main.Approval == false)
            {
                Main.Selected_Data = null;
            }
            return Main.Selected_Data;
        }
