...
namespace Accounts
{
    public partial class FrmProjectPOEntry : Form, Entry
    {
        ...
        void PONO_Generate()
        {
            ...
            {                
                ...
                MyBase.Load_Data("Select Dbo.[Get_Max_Project_PO] ('" + String.Format("{0:dd-MMM-yyyy}", DtpDate.Value) + "')", ref Tdt);
        ...
        void Fill_Data(DataRow Dr)
        {
            try
            {
                ...
                TxtIndent.Text = Dr["Indent_No"].ToString();
                DtpIndent.Value = Convert.ToDateTime(Dr["Indent_Date"]); 
        ...
        public void Entry_Edit()
        {
            try
            {
                ...
                MyBase.Clear(this);
                lblMail.Text = "";
                Dr = Tool.Selection_Tool_Resize(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select PO Details - Edit", "select PoNo, Supplier, PoDate, Indent_NO, Indent_Date, Proj_Type, Proj_ACtivity_NAme, Order_No, PArty, Item, Color, Size, Uom1, Order_Qty_Conv Order_Qty, Cancel_Qty_Conv Cancel_Qty, Grs_Rate_Conv Grs_Rate, Tax_Per, Freight_Rate_Conv Freight_Rate, Rate_Conv Pur_Rate, Grs_Amount_Dtl, Tax_Amount_Dtl, Freight_Amount_Dtl, Pur_Amount, Approval_Flag_PO First_Approval, Approval_Flag_PO1 Second_Approval, REquired_Date, Ack_Date, Commit_Date, MailId, Tot_Grs_Amount, Tot_Tax_Amount, Tot_Freight_Amount, Tot_Net_Amount,  Remarks_Mas ,  Supplier_Code, Buyer_Code, Country_Code, Rowid, Detail_ID From Project_PO_Details_Fn() Where Rowid Not in (SElect C.Rowid From Project_Grn_Ocn_DEtails A Inner Join Project_Po_DEtails B On A.PO_DEtail_ID = B.Rowid Inner Join Project_Po_MAster C On B.Master_Id = C.Rowid ) ORder by 1 desc ", String.Empty, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100);
                if (Dr != null)
                {
                    Fill_Data(Dr);
                }
                    ...
                    return;
                                ...
                                if (Grid_Item.Rows.Count > 1)
                                {
                                    for (int i = 0; i <= Grid_Item.Rows.Count - 2; i++)
                                    {
                                        ...
                                        {
                                            MessageBox.Show("Pur Rate is greater than  App_Pur_Rate...!", "Gainup");
        ...
        public void Entry_Delete()
        {
            try
            {
                ...
                MyBase.Clear(this);
                lblMail.Text = "";
                Dr = Tool.Selection_Tool_Resize(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select PO Details - Delete", "select PoNo, Supplier, PoDate, Indent_NO, Indent_Date, Proj_Type, Proj_ACtivity_NAme, Order_No, PArty, Item, Color, Size, Uom1, Order_Qty_Conv Order_Qty, Cancel_Qty_Conv Cancel_Qty, Grs_Rate_Conv Grs_Rate, Tax_Per, Freight_Rate_Conv Freight_Rate, Rate_Conv Pur_Rate, Grs_Amount_Dtl, Tax_Amount_Dtl, Freight_Amount_Dtl, Pur_Amount, Approval_Flag_PO First_Approval, Approval_Flag_PO1 Second_Approval, REquired_Date, Ack_Date, Commit_Date, MailId, Tot_Grs_Amount, Tot_Tax_Amount, Tot_Freight_Amount, Tot_Net_Amount,  Remarks_Mas ,  Supplier_Code, Buyer_Code, Country_Code, Rowid, Detail_ID From Project_PO_Details_Fn() Where Rowid Not in (SElect C.Rowid From Project_Grn_Ocn_DEtails A Inner Join Project_Po_DEtails B On A.PO_DEtail_ID = B.Rowid Inner Join Project_Po_MAster C On B.Master_Id = C.Rowid ) ORder by 1 desc ", String.Empty, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100);
                if (Dr != null)
                {
                    Fill_Data(Dr);
        ...
        public void Entry_Delete_Confirm()
        {
            ...
            try
            {
                ...
                {
                    Queries[Array_Index++] = "Delete From Project_PO_Details Where Master_ID = " + Code;
                    Queries[Array_Index++] = "Delete From Project_PO_Master Where RowID = " + Code;
                    Queries[Array_Index++] = MyParent.EntryLog("PROJECT PO", "DELETE", Code.ToString());
                    MyBase.Run(Queries);
        ...
        public void Entry_View()
        {
            try
            {
                ...
                MyBase.Clear(this);
                lblMail.Text = "";
                Dr = Tool.Selection_Tool_Resize(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select PO Details - View", "select PoNo, Supplier, PoDate, Indent_NO, Indent_Date, Proj_Type, Proj_ACtivity_NAme, Order_No, PArty, Item, Color, Size, Uom1, Order_Qty_Conv Order_Qty, Cancel_Qty_Conv Cancel_Qty, Grs_Rate_Conv Grs_Rate, Tax_Per, Freight_Rate_Conv Freight_Rate, Rate_Conv Pur_Rate, Grs_Amount_Dtl, Tax_Amount_Dtl, Freight_Amount_Dtl, Pur_Amount, Approval_Flag_PO First_Approval, Approval_Flag_PO1 Second_Approval, REquired_Date, Ack_Date, Commit_Date, MailId, Tot_Grs_Amount, Tot_Tax_Amount, Tot_Freight_Amount, Tot_Net_Amount,  Remarks_Mas , Supplier_Code, Buyer_Code, Country_Code, Rowid, Detail_ID From Project_PO_Details_Fn() ORder by 1 desc ", String.Empty, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100);
                if (Dr != null)
                {
                    Fill_Data(Dr);
                }
        ...
        public void Entry_Print()
        {
            try
            {
                ...
                MyParent.FormulaFill(ref ObjRpt, "Heading", "MATERIAL PO ORDER");
                
                if (Res == DialogResult.Yes)
                {
                    MyParent.CReport(ref ObjRpt, "Material Purchase Order..!");

                }
                else if (Res == DialogResult.No)
                {
                    String Machine_Like = Tool.Get_Input(this, SelectionTool_Class.Input_Type.String, "Enter MailID", "Mail");

                    if (Machine_Like == null)
                    {
                        return;
                    }

                    if (Machine_Like != String.Empty)
                    {
                        ...
                        MyParent.CReport_Normal_PDF(ref ObjRpt, "Material Purchase Order..!", "C:\\Vaahrep\\GainupPO.Pdf", false);
                        MyBase.sendEMailThroughOUTLOOK_Send(Machine_Like, "", " Material Purchase Order..!", " ", "C:\\Vaahrep\\GainupPO.pdf");
        ...
        private void FrmProjectPOEntry_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FrmProjectPOEntry_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    if (this.ActiveControl.Name == "TxtBuyer")
                    {
                            Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Buyer", " Select LedgeR_Name Buyer, LedgeR_Code Code From Buyer_All_Fn() ", String.Empty, 250);
                            if (Dr != null)
                            {
                    ...
                    {
                        Int16 Cont =0;                                                 
                            Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Supplier", "Select LedgeR_Name Supplier, LedgeR_Email, LedgeR_Code Code, Country_COde, 0 Old_ID From Supplier_All_Fn()  ", String.Empty, 250, 200);
                            if (Dr != null)
                            {
        ...
        private void FrmProjectPOEntry_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (this.ActiveControl is TextBox)
            ...
            {                 
                for (int i = 0; i < Grid_Item.Rows.Count - 1; i++)
                {
                    ...
                    if (Grid_Item["PROJ_TYPE_ID", i].Value.ToString() != String.Empty && Grid_Item["PROJ_ACTIVITY_ID", i].Value.ToString() != String.Empty)
                    {
                        ...
                        if (Convert.ToDouble(Grid_Item["TAX_PER", i].Value) == 0)
                        {
                            Grid_Item["TAX_RATE", i].Value = "0.00";
                        }
                        ...
                        if (Grid_Item["CALC_TYPE", i].Value.ToString() == "*")
                        {
                            ...
                            Grid_Item["GRS_AMT", i].Value = String.Format("{0:0.0000}", Math.Round(Convert.ToDouble(Grid_Item["GRS_RATE_CONV", i].Value) * Convert.ToDouble(Grid_Item["PO_QTY_CONV", i].Value), 2));
                            Grid_Item["TAX_AMT", i].Value = String.Format("{0:0.0000}", Math.Round(Convert.ToDouble(Grid_Item["TAX_RATE_CONV", i].Value) * Convert.ToDouble(Grid_Item["PO_QTY_CONV", i].Value), 2));
                            Grid_Item["FREI_AMT", i].Value = String.Format("{0:0.0000}", Math.Round(Convert.ToDouble(Grid_Item["FREI_RATE_CONV", i].Value) * Convert.ToDouble(Grid_Item["PO_QTY_CONV", i].Value), 2));
                            Grid_Item["PUR_AMT", i].Value = String.Format("{0:0.0000}", Math.Round(Convert.ToDouble(Grid_Item["PUR_RATE_CONV", i].Value) * Convert.ToDouble(Grid_Item["PO_QTY_CONV", i].Value), 2));
                        ...
                        else
                        {
                            ...
                            Grid_Item["PUR_RATE", i].Value = String.Format("{0:0.0000}", Math.Round((Convert.ToDouble(Grid_Item["GRS_RATE", i].Value) + Convert.ToDouble(Grid_Item["FREIGHT_RATE", i].Value)) + Convert.ToDouble(Grid_Item["TAX_RATE", i].Value) - Convert.ToDouble(Grid_Item["RO_RATE", i].Value), 4));
                            Grid_Item["GRS_AMT", i].Value = String.Format("{0:0.00}", Math.Round(Convert.ToDouble(Grid_Item["PO_QTY", i].Value) / Convert.ToDouble(Grid_Item["GRS_RATE", i].Value), 2));
                            if (Convert.ToDouble(Grid_Item["TAX_RATE", i].Value) == 0)
                            {
                                Grid_Item["TAX_AMT", i].Value = "0";
                            }
                            else
                            {
                                Grid_Item["TAX_AMT", i].Value = String.Format("{0:0.00}", Math.Round(Convert.ToDouble(Grid_Item["PO_QTY", i].Value) / Convert.ToDouble(Grid_Item["TAX_RATE", i].Value), 2));
                            }
                            if (Convert.ToDouble(Grid_Item["FREIGHT_RATE", i].Value) == 0)
                            {
                                Grid_Item["FREI_AMT", i].Value = "0";
                            }
                            else
                            {
                                Grid_Item["FREI_AMT", i].Value = String.Format("{0:0.00}", Math.Round(Convert.ToDouble(Grid_Item["PO_QTY", i].Value) / Convert.ToDouble(Grid_Item["FREIGHT_RATE", i].Value), 2));
                ...
                if (e.KeyCode == Keys.Down)
                {
                    if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["ORDER_NO"].Index)
                    {
                        ...
                        if (lblMail.Tag.ToString() == "1")
                        {
                            if (TxtBuyer.Text.Trim() == String.Empty)
                            {
                                Dr = Tool.Selection_Tool_Except_New_Resize("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO, Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo, '/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom ProjectPO_Pending_Items_All_Grid_View  ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                            }
                            else
                            {
                                Dr = Tool.Selection_Tool_Except_New_Resize("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO, Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo,'/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom ProjectPO_Pending_Items_All_Grid_View  Where Party_Code = " + TxtBuyer.Tag + " ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                            }
                        }
                        else
                        {
                    ...
                    else if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["UOM1"].Index)
                    {
                        ...
                        Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select UOM", "select UOM, Conv, Calc_Type,  UOMID From Project_Uom_Settings_Fn(" + Grid_Item["UOMID", Grid_Item.CurrentCell.RowIndex].Value + ") ", String.Empty, 100, 100, 100, 100);
            ...
            try
            {
                ...
                if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["PO_Qty"].Index)
                {
                    ...
                    else
                    {
                        ...
                        {
                            MessageBox.Show("PO Qty is greater than Balance ...!", "Gainup");
                            Grid_Item["PO_Qty", Grid_Item.CurrentCell.RowIndex].Value = Grid_Item["Bal", Grid_Item.CurrentCell.RowIndex].Value;
                            Grid_Item.CurrentCell = Grid_Item["PO_Qty", Grid_Item.CurrentCell.RowIndex];
                            Grid_Item.Focus();
                            Grid_Item.BeginEdit(true);
                        }
                ...
                else if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["Freight_Rate"].Index)
                {
                    ...
                    else
                    {
                        if ((Convert.ToDouble(Grid_Item["Freight_Rate", Grid_Item.CurrentCell.RowIndex].Value) > Convert.ToDouble(Grid_Item["App_Frei", Grid_Item.CurrentCell.RowIndex].Value)) || (Convert.ToDouble(Grid_Item["Frei_Rate_Conv", Grid_Item.CurrentCell.RowIndex].Value) > Convert.ToDouble(Grid_Item["App_Frei_Org_Conv", Grid_Item.CurrentCell.RowIndex].Value)))
                        {
                            ...
                            //Grid_Item.CurrentCell = Grid_Item["Freight_Rate", Grid_Item.CurrentCell.RowIndex];
                            //Grid_Item.Focus();
                            //Grid_Item.BeginEdit(true);
                        }                        
                        else
                ...
                else if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["Grs_Rate"].Index || Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["Tax_Per"].Index || Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["Freight_Rate"].Index || Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["Ro_Amt"].Index)
                {
                    ...
                    {
                        if ((Convert.ToDouble(Grid_Item["Pur_Rate", Grid_Item.CurrentCell.RowIndex].Value) > Convert.ToDouble(Grid_Item["App_Pur_Rate", Grid_Item.CurrentCell.RowIndex].Value)))
                        {
