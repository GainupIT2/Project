...
namespace Accounts
{
    public partial class FrmProjectSocksPOEntry : Form, Entry
    {
            ...
            try
            {
                ...
                else if (Res == DialogResult.No)
                {
                    if (Dt1.Rows[0]["Supplier_Email"].ToString() != String.Empty)
                    {
                        ...
                        MyBase.sendEMailThroughOUTLOOK_Send(Dt1.Rows[0]["Supplier_Email"].ToString(), "Fit@gainup.in", " Material Purchase Order..!", " ", "C:\\Vaahrep\\GainupPO.pdf");
        ...
        private void FrmProjectSocksPOEntry_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FrmProjectSocksPOEntry_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
        ...
        private void FrmProjectSocksPOEntry_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (this.ActiveControl is TextBox)
